...
st.set_page_config(page_title="Email Tonifier", page_icon=":robot:")
st.header("Email Tonifier")
...
def get_text():
    input_text = st.text_area(label="Email Input", label_visibility='collapsed', placeholder="Your Email Content...", key="email_input")
    return input_text
...
def update_text_with_example():
    print ("in updated")
    st.session_state.email_input = "Aman I am starts work at yours sunday from elon. Timing same as 9am to 5pm. Holiday Saturday."
